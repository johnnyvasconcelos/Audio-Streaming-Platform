    ...
    return (
        <nav className="top__bar">
            <div className="top__container container flex">
                ...
                <div className="top__mobile--button" onClick={() => {
                    showMenuFunction()
                }}>
                    { showMenu ?
            ...
            <img src={logoPurple} alt="Audio Streaming Platform - Logo." />
                    <li className="top__menu--item">
                        <Link className={path === '/' ? "top__menu--link active" : 'top__menu--link'} to="/" onClick={() => {
                    showMenuFunction()
                }}>Home</Link>
                    </li>
                    <li className="top__menu--item">
                        <Link className={path === '/about' ? "top__menu--link active" : 'top__menu--link'} to="/about" onClick={() => {
                    showMenuFunction()
                }}>About</Link>
                    </li>
                    <li className="top__menu--item">
                        <Link className={path === '/songs' ? "top__menu--link active" : 'top__menu--link'} to="/songs" onClick={() => {
                    showMenuFunction()
                }}>Singles</Link>
                    </li>
                    <li className="top__menu--item">
                        <Link className={path === '/artists' ? "top__menu--link active" : 'top__menu--link'} to="/artists" onClick={() => {
                    showMenuFunction()
                }}>Artists</Link>
                    </li>
                    <li className="top__menu--item">
                        <Link className={path === '/plans' ? "top__menu--link active" : 'top__menu--link'} to="/plans" onClick={() => {
                    showMenuFunction()
                }}>Plans</Link>
                    </li>
